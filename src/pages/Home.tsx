...
const Home: React.FC = () => {
	...
	<IonPage>
          ...
          <IonContent className="ion-padding">
            ...
            <CakeDisplay />
            <div id="about"><Profile name="Jake Zwiebach" image="zwiebach.jpg" description="Hi im a jew and I make the cheesecake from my Jesus. The secret recipe for these cheesecakes has been past down in my family for generations. Our twicebaked cheesecakes become the center of celebrations at potlucks and dinners - always eaten first. Our last name, Zwiebach, actually means twice baked, just like our cheesecakes." tags={['Owner','Sinner','Anarchist']}/></div>
            <Footer />
          </IonContent>
